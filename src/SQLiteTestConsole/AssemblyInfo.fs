...
[<assembly: AssemblyTitleAttribute("SQLiteTestConsole")>]
[<assembly: AssemblyProductAttribute("SQLiteTest")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "SQLiteTestConsole"
    let [<Literal>] AssemblyProduct = "SQLiteTest"
